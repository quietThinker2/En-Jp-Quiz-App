...
class VocabQuizActivity : AppCompatActivity(), OnPopupDismissListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val values = dbHelper.extractVocabOrSentence("V",segmentID)
    ...
    private fun showPopUp(userText: String, segmentID: Int, values: ArrayList<String>, listener: OnPopupDismissListener){
        ...
        dialog.setOnDismissListener {
            val dbHelper = SQLiteHelper(this)
            val updatedList = dbHelper.extractVocabOrSentence("V", segmentID)
